This assignment demonstrates deserialization and then serialization of an object using java reflection.
...
ant -buildfile src/build.xml run -Darg0=inputFile.txt -Darg1=outputFile.txt -Darg2=0