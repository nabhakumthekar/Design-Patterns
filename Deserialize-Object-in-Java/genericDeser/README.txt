This assignment deserializes objects from input file using java reflection. 
It also gives count of unique and totals instances of objects of type first & second.
